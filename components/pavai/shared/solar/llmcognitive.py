...
from .llmchat import moderate_and_query, take_second_options, moderate_and_query_skip_safety_check
from .llmdatasecurity import DataSecurityEngine
from .llmclassify import text_to_domain_model_mapping,domain_models_map
from .llmfunctionary import self_critique
from .llmcontentguard import safety_check
from .llmprompt import lookup_expert_system_prompt, system_prompt_assistant, system_prompt_default
import textwrap
...
class StartAction(Action):
    ...
    def __init__(self, network: LLMSolarNetwork) -> None:
...
class ThinkAction(Action):
    ...
    def __init__(self, network: LLMSolarNetwork, receiver: LLMReceiver) -> None:
        """
