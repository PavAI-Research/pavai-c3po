...
def classify_intent(query: str, model_id: str = "Falconsai/intent_classification", cache_dir: str = "./models"):
    device = "cuda:0" if torch.cuda.is_available() else "cpu"
    torch_dtype = torch.float16 if torch.cuda.is_available() else torch.float32
...
def classify_single_topic(query: str, model_id: str = "cardiffnlp/tweet-topic-21-multi", cache_dir: str = "./models"):
    device = "cuda:0" if torch.cuda.is_available() else "cpu"
    torch_dtype = torch.float16 if torch.cuda.is_available() else torch.float32
...
def classify_multiple_topics(query: str, model_id: str = "cardiffnlp/tweet-topic-21-multi", cache_dir: str = "./models", low_cpu_mem_usage: bool = True, use_safetensors: bool = True):
