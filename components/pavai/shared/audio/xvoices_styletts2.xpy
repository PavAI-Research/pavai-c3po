...
from pavai.shared.styletts2 import librispeech, compute_style, test_libris_speech
...
human_reference_voices = {
    ...
    "Anthony": compute_style("resources/models/styletts2/reference_audio/anthony.wav"),
    "c3p013": compute_style("resources/models/styletts2/reference_audio/c3p013.wav"),
    "c3p0voice13": compute_style("resources/models/styletts2/reference_audio/c3p0_voice13.wav"),        
    "c3p0voice1": compute_style("resources/models/styletts2/reference_audio/c3p0_voice1.wav")
}
...
def librispeak(text: str, compute_style: str = "c3p0voice1", alpha=0.3, beta=0.7, chunk_size=350,
