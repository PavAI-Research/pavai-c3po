...
from pavai.functions.functionary.prompt_template.base_template import (
    SYSTEM_MESSAGE,
    PredefinedFuncTypes,
    PromptTemplate,
)
from pavai.functions.functionary.prompt_template.prompt_template_v1 import PromptTemplateV1
from pavai.functions.functionary.prompt_template.prompt_template_v2 import PromptTemplateV2
